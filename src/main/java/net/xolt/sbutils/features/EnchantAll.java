...
public class EnchantAll {
    ...
    private static void sendEnchantAllCommand() {
        ...
        MC.getNetworkHandler().sendPacket(new CommandExecutionC2SPacket("enchantall", Instant.now(), 0L,
                ArgumentSignatureDataMap.EMPTY, false, MC.getNetworkHandler().consumeAcknowledgment()));
        afterSendCommand();
    }
